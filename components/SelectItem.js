...
const ItemButton = ({
  ...
  <div className="flex items-center justify-center border-l border-gray-700 bg-gray-100">
    <Tooltip title={tooltip}>
      <button
        onClick={onClick}
        className={cn(
          'font-futuraDemi group flex h-full items-center justify-center gap-x-0.5 whitespace-nowrap rounded-r shadow',
          thin ? 'px-1' : 'px-1.5'
        )}
      >
        {icon ? (
          <FontAwesomeIcon
            className={cn(
              'h-4 w-4 duration-300 group-hover:scale-125',
              iconClassName
            )}
            icon={icon}
          />
  ...
  return (
    ...
    >
      ...
      {selectedId && showEditButton && (
        <div
          className="group flex w-7 cursor-pointer items-center justify-center border-l border-gray-700 bg-gray-100 text-orange-500"
          onClick={() => {
      ...
      {selectedId && showEventUsersButton && (
        <div
          className="group flex w-7 cursor-pointer items-center justify-center border-l border-gray-700 bg-gray-100 text-green-500"
          onClick={() => {
