...
const MagicanImage = () => (
  <div className="absolute flex justify-center z-10 left-[min(calc(40%),calc(12%+260px))] bottom-[80px] phoneH:bottom-0 sm:bottom-auto top-auto sm:top-0 w-[96%] sm:w-[max(300px,97%)] sm:h-full max-h-full tablet:max-h-[1035px]">
